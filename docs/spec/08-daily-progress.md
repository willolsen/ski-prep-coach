...
The user should see progress for the day, but not a rigid plan. Like everything else derived from history, this is computed on demand ([Daily Progress](./07-result-processing.md#daily-progress)) — not a stored daily counter that gets incremented and reset.
